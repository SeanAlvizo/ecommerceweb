...
class FurnitureSeeder extends Seeder
{
    public function run()
    {
        ...
        User::create([
            'name' => 'Admin',
            'email' => 'admin@algura.ph',
            'password' => Hash::make('password123'),
            'role' => 'admin',
        ]);

        $this->command->info('✅ Seeded 3 categories, 4 products, and 1 admin user');
        $this->command->info('   Admin: admin@algura.ph / password123');
    }
}
